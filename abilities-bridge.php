 ...
 * Description: MCP server for WordPress with admin interface. Connect Claude AI to execute WordPress Abilities with configurable permissions, activity monitoring, memory storage, and OAuth 2.0 authentication.
 * Version: 1.0.0
 * Author: Joe Campbell
...
define( 'ABILITIES_BRIDGE_VERSION', '1.0.0' );
