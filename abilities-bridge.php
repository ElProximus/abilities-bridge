...
define( 'ABILITIES_BRIDGE_VERSION', '1.4.1' );
...
function abilities_bridge_run_oauth_cleanup() {
	...
	// Cleanup expired pending OAuth state (abandoned authorization flows).
	Abilities_Bridge_Pending_Store::cleanup_expired();

	// Cleanup expired access and refresh tokens.
